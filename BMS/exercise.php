...
if (isset($_REQUEST['phone'])) { 
   if (isset($_REQUEST['text'])) { 
      $x = SendSMS("192.168.0.1", 8800, "Shadow", "sskgler123", $_REQUEST['phone'], $_REQUEST['text']); 
      echo $x; 
   } 
   else { 
...
$sms_url=sprintf(“http://alerts.kapsystem.com/api/..., $workingkey, $dest_MobileNo,$SenderID, urlencode($Message));
