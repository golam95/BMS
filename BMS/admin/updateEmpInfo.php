...
<div class="content">
		...
		<div class="titleleft">
		   <ul class="breadcrumb">
            ...
            <li><a href="viewEmp.php"><span class="glyphicon glyphicon-arrow-left"></span> ViewEmp</a> </li>
	...
	<div class="form-group">
		 ...
		 <div class="form-group">
			...
			<div class="form-group">
			   ...
			   <button class="form-control"  type="submit" name="rejine" class="btn"><span class="glyphicon glyphicon-remove">Rejine</button>
