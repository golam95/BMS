...
<div class="relative">
 <div class="row">
              <div class="col-md-12">
             <div><h2 style="text-align:center;font-weight:bold;color:#C8A067;">LogIn</h2></div>
            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" action="" method="post"  id="getOrderReportForm">
                  ...
                  <div class="form-group">
                    <label style="color:#C8A067;" for="startDate" class="col-sm-2 control-label">Password</label>
                    <div class="col-sm-10">
                     <div class="input-group">
               ...
               <a style="color:#C8A067;" href="forgetpass.php">Forgot Password</a>
            </div>
            </div>
