		...
		<!---footer--->
		  ...
		  <section class="checkfirst">
		     <div class="container">
			   <div class="row">
					   <div class="col-md-3">
						 <div class="customDiv">
						   <h3><a href="delivery.html">Delivery Policey</a></h3>
						 </div>
					   </div>
						 <div class="col-md-3">
						 <div class="customDiv">
						   <h3><a href="#">Delivery Policey</a></h3>
						 </div>
					   </div>
						 <div class="col-md-3">
						 <div class="customDiv">
						...
						<div class="container">
							<div class="footer-grids">
								...
								<div class="col-md-3 footer-grid foot">
									<h4>Contacts</h4>
									<ul>
										<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i><a href="#">Mohammadpur Society 8</a></li>
										<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i><a href="#">01755719929</a></li>
										<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:example@mail.com">sager@gmail.com</a></li>
